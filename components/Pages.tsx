    ...
    <div className="kaif-portfolio-body bg-[#101016] text-[#f4f4f6] font-sans antialiased overflow-x-hidden min-h-screen">
      ...
      <header className="relative pt-44 pb-28 overflow-hidden" id="top">
        ...
        <div className="max-w-[1180px] mx-auto px-8 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-14 items-center">
          ...
          {/* PORTRAIT */}
          <div className="lg:col-span-4 relative max-w-[340px] w-full mx-auto lg:ml-auto flex flex-col gap-5">
            <div className="relative">
            ...
            {/* status card relocated below the image */}
            <div className="relative z-10 bg-[#181822]/80 backdrop-blur-md border border-white/10 rounded-2xl p-4 flex items-center justify-center gap-3 shadow-xl w-full">
              <span className="w-2.5 h-2.5 rounded-full bg-[#5eead4] shadow-[0_0_0_4px_rgba(94,234,212,0.2)] animate-pulse"></span>
              <div className="text-center">
                <p className="font-tech font-bold text-sm text-white">Available for work</p>
                <p className="text-[10px] text-slate-400 mt-0.5">Usually replies in under an hour</p>
              </div>
            </div>
          </div>
        </div>
